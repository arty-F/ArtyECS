...
public class CoreTests : TestBase
{
    ...
    public void Test_Pool_002()
    {
        ...
        ExecuteTest(testName, () =>
        {
            // Call EntityPool.Allocate() three times
            Entity entity1 = EntityPool.Allocate();
            Entity entity2 = EntityPool.Allocate();
            Entity entity3 = EntityPool.Allocate();
    ...
    public void Test_Pool_003()
    {
        ...
        ExecuteTest(testName, () =>
        {
            ...
            // Deallocate Entity
            bool deallocated = EntityPool.Deallocate(entity);
    ...
    public void Test_Pool_004()
    {
        ...
        ExecuteTest(testName, () =>
        {
            ...
            bool deallocated = EntityPool.Deallocate(invalid);
    ...
    public void Test_Pool_006()
    {
        ...
        ExecuteTest(testName, () =>
        {
            ...
            Assert(!EntityPool.IsAllocated(oldEntity1), "Old Entity1 should not be allocated");
        });
    }
    ...
    public void Test_Pool_007()
    {
        ...
        ExecuteTest(testName, () =>
        {
            ...
            // Check IsAllocated
            bool allocated = EntityPool.IsAllocated(entity);
            
            // Deallocate Entity
            EntityPool.Deallocate(entity);
            
            // Check IsAllocated again
            bool allocatedAfter = EntityPool.IsAllocated(entity);
    ...
    public void Test_Pool_008()
    {
        ...
        ExecuteTest(testName, () =>
        {
            ...
            // Get final count
            int finalCount = EntityPool.GetAllocatedCount();
    ...
    public void Test_Pool_009()
    {
        ...
        ExecuteTest(testName, () =>
        {
            ...
            int initialAvailable = EntityPool.GetAvailableCount();
            ...
            EntityPool.Deallocate(entity1);
            EntityPool.Deallocate(entity2);
            
            // Get available count
            int finalAvailable = EntityPool.GetAvailableCount();
    ...
    public void Test_Pool_010()
    {
        ...
        ExecuteTest(testName, () =>
        {
            ...
            // Check counts
            int allocatedCount = EntityPool.GetAllocatedCount();
            int availableCount = EntityPool.GetAvailableCount();
    ...
    public void Test_Pool_011()
    {
        ...
        ExecuteTest(testName, () =>
        {
            ...
            Entity entity1 = EntityPool.Allocate(null);
            
            // Allocate Entity2 in testWorld
            Entity entity2 = EntityPool.Allocate(testWorld);
            
            // Check counts in each world
            int globalCount = EntityPool.GetAllocatedCount(null);
            int testCount = EntityPool.GetAllocatedCount(testWorld);
    ...
    public void Test_Pool_012()
    {
        ...
        ExecuteTest(testName, () =>
        {
            ...
            // Deallocate Entity
            bool firstDealloc = EntityPool.Deallocate(entity);
            
            // Attempt to deallocate Entity again
            bool secondDealloc = EntityPool.Deallocate(entity);
    ...
    public void Test_World_001()
    {
        ...
        ExecuteTest(testName, () =>
        {
            ...
            // Verify returns valid Entity
            Assert(entity.IsValid, "Entity should be valid");
            Assert(EntityPool.IsAllocated(entity), "Entity should be allocated");
        });
    }
    ...
    public void Test_World_003()
    {
        ...
        ExecuteTest(testName, () =>
        {
            ...
            Assert(EntityPool.IsAllocated(entity1, null), "Entity1 should be allocated in global world");
            Assert(EntityPool.IsAllocated(entity2, testWorld), "Entity2 should be allocated in testWorld");
        });
    }
    ...
    public void Test_World_009()
    {
        ...
        ExecuteTest(testName, () =>
        {
            ...
            Assert(!compTest.HasValue, "Component should be removed from testWorld");
            Assert(compGlobal.HasValue, "Component should remain in global world");
            Assert(!EntityPool.IsAllocated(entity, testWorld), "Entity should not be allocated in testWorld");
        });
    }
    ...
    public void Test_Integration_002()
    {
        ...
        ExecuteTest(testName, () =>
        {
            ...
            Assert(!EntityPool.IsAllocated(entity1, world1), "Entity1 should not be allocated");
            Assert(!EntityPool.IsAllocated(entity2, world2), "Entity2 should not be allocated");
            Assert(!EntityPool.IsAllocated(entity3, world3), "Entity3 should not be allocated");
        });
    }
